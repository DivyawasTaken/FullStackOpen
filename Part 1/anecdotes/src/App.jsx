...
const App = () => {
  ...
  const handleVote = () => {
    const copyied_points = [...points]
    copyied_points[selected] += 1
    setPoints(copyied_points)
    sethighestVotes(copyied_points.indexOf(Math.max(...copyied_points)))
  }
  ...
  return (
    <div>
      ...
      <Anecdote title={"Anecdote with most votes"} textContent={anecdotes[highestVotes]} votes={points[highestVotes]} />
    </div>
  )
}
